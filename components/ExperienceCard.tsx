  ...
  return (
    ...
    >
      <motion.img
        ...
        viewport={{ once: true }}
        src="https://www.pbs.org/wnet/nature/files/2020/06/black-white-and-yellow-tiger-sitting-on-a-beige-sand-during-47312-scaled.jpg"
      ...
      <div className="px-0 md:px-10">
        ...
        <div className="flex space-x-2 my-2">
          <img
            ...
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSp7TRrXVgnocsKKACWW0jWWWriwSa2_FxIqg&usqp=CAU"
            alt=""
          />
          <img
            className="h-10 w-10 rounded-full"
