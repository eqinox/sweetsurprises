    ...
    >
        ...
        <article className={styles.article}>
            <div className={styles.articleInfo}>
                ...
                <p>
                    <b>Солариум:</b> Насладете се на естествен и здравословен тен с нашите съвременни солариуми. Постигнете мечтания загар, докато се отпуснете в комфортна и безопасна среда.
                    <br />
                    <b>Масаж:</b> Потопете се в света на релаксацията с нашите професионални масажи.
                    Отпуснете стреса и напрежението с разнообразие от масажни техники, които ще възвърнат баланса и енергията на вашето тяло.
<br />
                    <b>Маникюр и педикюр:</b> Вашите ръце и крака заслужават най-добрата грижа. Ние предлагаме широка гама от маникюр и педикюр услуги, които ще подчертаят вашата красота и стил.
                </p>
            </div>
            <div className={styles.smallImageGallery}>
                <PhotoProvider>
